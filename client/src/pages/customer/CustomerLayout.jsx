...
const CustomerLayout = () => {
  ...
  useEffect(() => {
    setNotifications([
      { id: 1, message: "Your order #12345 has been shipped", time: "2h ago" },
      { id: 2, message: "New products available in store", time: "1d ago" },
    ]);
  }, []);
  ...
  const links = [
    ...
    { name: "Track Order", path: "/dashboard/track", icon: Package },
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-emerald-900 shadow-xl transform
      ...
      >
        <div className="flex items-center justify-between p-6 border-b border-emerald-800">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-white">Customer Area</h2>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
            className="md:hidden p-1.5 rounded-lg hover:bg-emerald-800 text-gray-300 hover:text-white transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
            ...
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-all ${
                location.pathname === path
                  ...
                  : "text-gray-300 hover:bg-green-950 hover:text-white"
              }`}
            >
      ...
      <div className="flex-1 flex flex-col md:ml-64">
        {/* Top Bar */}
        <header className="bg-gray-200 shadow-sm px-6 py-4 border-b border-gray-200 sticky top-0 z-30">
