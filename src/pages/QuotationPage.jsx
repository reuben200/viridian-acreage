...
const QuotationPage = () => {
    ...
    const addProductRow = () => {
        setFormData((prev) => ({
            ...prev,
            products: [...prev.products, { productId: "", productName: "", quantity: 1, unit: "" }],
        }));
    };
            ...
            <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center px-4">
                ...
                >
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-6">
                        Thank you — your quotation has been submitted. We will review and get back to you.
                    </p>
                    <button
                                ...
                                <div className="space-y-3">
                                    {formData.products.map((row, idx) => (
                                        <div key={idx} className="grid grid-cols-12 gap-2 items-center">
                                            {/* 🔹 Dropdown now uses Firestore products */}
                                            <select
                                                value={row.productId}
                                                onChange={(e) => {
